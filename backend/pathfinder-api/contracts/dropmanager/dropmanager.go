...
// UnlockDrop is a paid mutator transaction binding the contract method 0x496617d2.
//
// Solidity: function unlockDrop((bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,bytes32) proof, bytes32 lockId) returns()
func (_Dropmanager *DropmanagerTransactor) UnlockDrop(opts *bind.TransactOpts, proof DropManagerProofData, lockId [32]byte) (*types.Transaction, error) {
	return _Dropmanager.contract.Transact(opts, "unlockDrop", proof, lockId)
}

// UnlockDrop is a paid mutator transaction binding the contract method 0x496617d2.
//
// Solidity: function unlockDrop((bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,bytes32) proof, bytes32 lockId) returns()
func (_Dropmanager *DropmanagerSession) UnlockDrop(proof DropManagerProofData, lockId [32]byte) (*types.Transaction, error) {
	return _Dropmanager.Contract.UnlockDrop(&_Dropmanager.TransactOpts, proof, lockId)
}

// UnlockDrop is a paid mutator transaction binding the contract method 0x496617d2.
//
// Solidity: function unlockDrop((bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,bytes32) proof, bytes32 lockId) returns()
func (_Dropmanager *DropmanagerTransactorSession) UnlockDrop(proof DropManagerProofData, lockId [32]byte) (*types.Transaction, error) {
	return _Dropmanager.Contract.UnlockDrop(&_Dropmanager.TransactOpts, proof, lockId)
}
